...
<template>
  <article class="article-item" @click="goDetail">
...
.article-item {
  ...
  margin: 0 16px 12px;
  box-shadow: 0 2px 16px rgba(60, 120, 180, 0.08);
...
.article-item:active {
  ...
  box-shadow: 0 1px 4px rgba(60, 120, 180, 0.05);
}
...
.group-tag {
  ...
  background: rgba(75, 155, 210, 0.1);
  padding: 3px 11px;
  border-radius: 20px;
